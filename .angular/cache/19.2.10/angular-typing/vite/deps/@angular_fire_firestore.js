...
import {
  ...
  ɵzoneWrap
} from "./chunk-VP4FQGIA.js";
import "./chunk-EDJT7BPU.js";
import {
  InjectionToken,
  Injector,
  NgModule,
...
var __PRIVATE_SimpleDb = class ___PRIVATE_SimpleDb {
  ...
  k(e) {
    return __async(this, null, function* () {
      return this.db || (__PRIVATE_logDebug(Q, "Opening database:", this.name), this.db = yield new Promise((t, n) => {
...
var __PRIVATE_IndexBackfillerScheduler = class {
  ...
  ie(e) {
    __PRIVATE_logDebug(U, `Scheduled in ${e}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill", e, () => __async(this, null, function* () {
      this.task = null;
      try {
        const e2 = yield this.re.se();
        __PRIVATE_logDebug(U, `Documents written: ${e2}`);
      } catch (e2) {
        __PRIVATE_isIndexedDbTransactionError(e2) ? __PRIVATE_logDebug(U, "Ignoring IndexedDB error during index backfill: ", e2) : yield __PRIVATE_ignoreIfPrimaryLeaseLoss(e2);
      }
      yield this.ie(6e4);
    }));
  }
...
var __PRIVATE_LruScheduler = class {
  ...
  Ir(e) {
    __PRIVATE_logDebug(Ct, `Garbage collection scheduled in ${e}ms`), this.Tr = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, () => __async(this, null, function* () {
      this.Tr = null;
      try {
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  shutdown() {
    return __async(this, null, function* () {
      ...
      yield this.Li.runTransaction("shutdown", "readwrite", [z, fe], (e) => {
...
var FirestoreClient = class {
  constructor(e, t, n, r, i) {
    this.authCredentials = e, this.appCheckCredentials = t, this.asyncQueue = n, this.databaseInfo = r, this.user = User.UNAUTHENTICATED, this.clientId = __PRIVATE_AutoId.newId(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this._uninitializedComponentsProvider = i, this.authCredentials.start(n, (e2) => __async(this, null, function* () {
      __PRIVATE_logDebug(en, "Received user=", e2.uid), yield this.authCredentialListener(e2), this.user = e2;
...
function __PRIVATE_setOnlineComponentProvider(e, t) {
  return __async(this, null, function* () {
    ...
    __PRIVATE_logDebug(en, "Initializing OnlineComponentProvider"), yield t.initialize(n, e.configuration), // The CredentialChangeListener of the online component provider takes
...
function __PRIVATE_ensureOfflineComponents(e) {
  return __async(this, null, function* () {
    ...
    } else __PRIVATE_logDebug(en, "Using default OfflineComponentProvider"), yield __PRIVATE_setOfflineComponentProvider(e, new __PRIVATE_LruGcMemoryOfflineComponentProvider(void 0));
    return e._offlineComponents;
  });
}
function __PRIVATE_ensureOnlineComponents(e) {
  return __async(this, null, function* () {
    return e._onlineComponents || (e._uninitializedComponentsProvider ? (__PRIVATE_logDebug(en, "Using user provided OnlineComponentProvider"), yield __PRIVATE_setOnlineComponentProvider(e, e._uninitializedComponentsProvider._online)) : (__PRIVATE_logDebug(en, "Using default OnlineComponentProvider"), yield __PRIVATE_setOnlineComponentProvider(e, new OnlineComponentProvider()))), e._onlineComponents;
  });
}
